...
%% Part three: time compressing
% In this part, we will plot 2 plots in a single figure with subplot
% Fires upsample with factor 2 and second up2, filling with zeros method.
...
% Abs(FFT) of output of upsampling up2 approach
subplot(2,1,2)
up2 = up + [0;up(1:length(up)-1)];
plot(linspace(-pi,pi,length(up2)),abs(fftshift(fft(up2))))
xlim([-pi pi])
title('FFT of up2 upsampling of the input');

% Saving plot
saveas(3,'Results/Section2/Compare_Up&Up2', 'jpg');
