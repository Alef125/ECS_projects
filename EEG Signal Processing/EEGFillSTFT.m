...
Nbest=kSVD2; % Number of Choosed channels
...
for i=1:Nbest
        trainingData(:,1,i)= feature2( kFoldTry(kf1+1:660),i);
        
        trainingData(1:kf1,2,i)= feature2( kFoldTry(1:kf1) ,i);
        trainingData(kf1+1:kf4,2,i)= feature2( kFoldTry(kf2+1:660),i);
        
        trainingData(1:kf2,3,i)= feature2( kFoldTry(1:kf2) ,i);
        trainingData(kf2+1:kf4,3,i)= feature2( kFoldTry(kf3+1:660) ,i);
       
        trainingData(1:kf3,4,i)= feature2( kFoldTry(1:kf3) ,i);
        trainingData(kf3+1:kf4,4,i)= feature2( kFoldTry(kf4+1:660) ,i);
        
        trainingData(:,5,i)= feature2( kFoldTry(1:kf4),i);
end

%% Filling Test Datas
for i=1:Nbest
        testData(:,1,i)= feature2( kFoldTry(1:kf1) ,i);
        testData(:,2,i)= feature2( kFoldTry(kf1+1:kf2) ,i);
        testData(:,3,i)= feature2( kFoldTry(kf2+1:kf3) ,i);
        testData(:,4,i)= feature2( kFoldTry(kf3+1:kf4) ,i);
        testData(:,5,i)= feature2( kFoldTry(kf4+1:660) ,i);
end
